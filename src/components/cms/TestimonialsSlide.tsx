...
export default function TestimonialsSlide() {
	...
	const current = hasTestimonials ? testimonials[currentTestimonial] : null;
			...
			<div className="container">
				<AnimatedSection direction="up" delay={0.2}>
					<div className="text-center mb-16">
						<SectionHeading
							title="TRUSTED BY LEADING EXPERTS"
						...
						<div className="text-center relative min-h-[300px]">
								...
								>
									...
									<div className="mb-8">
										...
										<p className="text-white/70 text-sm">
											{current.fields.designation}, {current.fields.company}
										</p>
									</div>
								</motion.div>
							</AnimatePresence>
							...
							>
								<motion.button
									...
									className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-colors flex items-center justify-center disabled:opacity-40"
									whileHover={{ scale: 1.1 }}
								>
